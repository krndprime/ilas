...
class Rdemployer extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['parent', 'child', 'employerType_id', 'registrationAuthority_id', 'ownership_id', 'createdBy', 'deletedFlag', 'deletedBy', 'updatedBy','tin'], 'integer'],
            ...
            [['companyName','employerType_id','ownership_id','openingDate','registrationAuthority_id'], 'required'],
