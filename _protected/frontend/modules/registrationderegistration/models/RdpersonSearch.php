...
/**
 * RdpersonSearch represents the model behind the search form about `backend\modules\registrationderegistration\models\Rdperson`.
 */
class RdpersonSearch extends Rdperson
{
    /**
     * @inheritdoc
     */
