 ...
 */
class Rdperson extends \yii\db\ActiveRecord
{
    public $province_id;
    public $district_id;
    public $sector_id;
    ...
    {
        return [
            [['document_id', 'nid','country_id', 'sex_id', 'village_id', 'createdBy', 'deletedFlag', 'deletedBy', 'updatedBy'], 'integer'],
            ...
            [['nid' ], 'unique'],
            [['nid'], 'match', 'pattern' => '/^\d{16}$/', 'message' => 'ID number must contain exactly 16 digits.'],
