...
/**
 * OshinjurySearch represents the model behind the search form about `backend\modules\osh\models\Oshinjury`.
 */
class OshinjurySearch extends Oshinjury
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'employee_id', 'injuryType_id', 'frequency_id', 'desease_id', 'injuryCategory_id', 'partOfTheBody_id', 'cause_id', 'oshTrainingRelatedToOccupation_id', 'affiliatedToRssb_id', 'createdBy', 'deletedFlag', 'deletedBy', 'updatedBy'], 'integer'],
