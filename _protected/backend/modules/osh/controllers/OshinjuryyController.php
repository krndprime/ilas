...
use backend\modules\osh\models\OshinjuryySearch;
...
/**
 * OshinjuryyController implements the CRUD actions for Oshinjuryy model.
 */
class OshinjuryyController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all Oshinjuryy models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new OshinjuryySearch();
    ...
    /**
     * Displays a single Oshinjuryy model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Oshinjuryy model.
                        ...
                        if( $person->save()){
                            ...
                            $model->employee_id = $person->id;
                                ...
                                if($model->save()){
                                    ...
                                    {
                                        $preventivemeasuremodel= new Oshpreventivemeasuree();
                    ...
                    if( $countPersons == 0 ){
                        ...
                        if( $person->save()){
                            ...
                            if($model->injuryType_id==1){
                                $model->desease_id=1;
                                $model->accident_id=$model->accident_id;
                            }else{
                                $model->desease_id=$model->desease_id;
                                $model->accident_id=1;
                            }
                                ...
                                if($model->save()){
                                    ...
                                    var_dump($model->preventivemeasure);die(); 
    ...
    /**
     * Updates an existing Oshinjuryy model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Oshinjuryy model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Oshinjuryy model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the Oshinjuryy model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Oshinjuryy the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Oshinjuryy::findOne($id)) !== null) {
            return $model;
        } else {
