...
<div class="socialfederation-form">

<?php $form = ActiveForm::begin(); ?>  
<div class='row'>
<div class="col-md-4">
<?= $form->field($model, 'confederation_id')->widget(select2::classname(),[
                            'data'=>ArrayHelper::map(Socialconfederation::find()->all(),'id','confederation'),
...
<div class="col-md-4"> 
  <?= $form->field($model, 'federation')->textInput(['maxlength' => true]) ?>    
 </div>
 <div class="col-md-4"> 
                        ...
                        'options'=>[
                            ...
                            'onchange'=>'
                                ...
                                $.post("'.Url::to(['../sdistrict/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                     $("select#socialfederation-district_id" ).html(data);
                                });'
                        ],
                        'language' => 'en',
                        'pluginOptions'=>['alloweClear'=>true],
...
'options'=>[
    ...
    'onchange'=>'
         ...
         data){
             $("select#socialfederation-sector_id" ).html(data);
        });'
],
'language' => 'en',
'pluginOptions'=>['alloweClear'=>true],
                            ...
                            'options'=>[
                                ...
                                'onchange'=>'
                                    $.post("'.Url::to(['../scell/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                         $("select#socialfederation-cell_id" ).html(data);
                                    });'
                            ],
                            'language' => 'en',
                            'pluginOptions'=>['alloweClear'=>true],
                            ...
                            'options'=>[
                                ...
                                'onchange'=>'
                                    $.post("'.Url::to(['../svillage/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                         $("select#socialfederation-village_id" ).html(data);
                                    });'
                            ],
                            'language' => 'en',
                            'pluginOptions'=>['alloweClear'=>true],
...
<div class="col-md-4">
 ...
 <div class="col-md-4">  
 <?= $form->field($model, 'federationRepresentativeNames')->textInput(['maxlength' => true]) ?>   
 </div>  
</div>
<div class='row'>
<div class="col-md-4">  
   <?= $form->field($model, 'federationRepresentativePhone')->textInput(['maxlength' => true]) ?>   
 </div> 
 </div>
