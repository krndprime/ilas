...
/**
 * This is the model class for table "{{%rd_numberOfUniqueEstablishment}}".
 *
 * @property int $id
 ...
 */
class RdNumberOfUniqueEstablishment extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%rd_numberOfUniqueEstablishment}}';
    }
