...
/* @var $model backend\modules\child\models\Childemployer */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="childemployer-form">
    ...
    <?= $form->field($model, 'document_id')->widget(select2::classname(),[
                            ...
                            'options'=>[
                                ...
                                // To get dropdownlist for courses
                                   ...
                                   var id = document.getElementById("childemployer-document_id").value;
                                   if(id == 1){
                                    $("#nid" ).show();
                                    $("#passport" ).hide();
                                    $("#document" ).hide();
                                    ...
                                    $.post("'.Url::to(['../childemployer/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                         $("select#" ).html(data);
                                    });'                                 
                            ],
                            'language' => 'en',
    ...
    <div class='row'>
                                ...
                                'options'=>[
                                    ...
                                    'onchange'=>'
                                        ...
                                        $.post("'.Url::to(['../sdistrict/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                             $("select#childemployer-district_id" ).html(data);
                                        });'
                                ],
                                'language' => 'en',
                                'pluginOptions'=>['alloweClear'=>true],
        ...
        'options'=>[
            ...
            'onchange'=>'
                 ...
                 data){
                     $("select#childemployer-sector_id" ).html(data);
                });'
        ],
        'language' => 'en',
        'pluginOptions'=>['alloweClear'=>true],
                                    ...
                                    'options'=>[
                                        ...
                                        'onchange'=>'
                                            $.post("'.Url::to(['../scell/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                                 $("select#childemployer-cell_id" ).html(data);
                                            });'
                                    ],
                                    'language' => 'en',
                                    'pluginOptions'=>['alloweClear'=>true],
                                    ...
                                    'options'=>[
                                        ...
                                        'onchange'=>'
                                            $.post("'.Url::to(['../svillage/lists', 'id'=> '']).'"+$(this).val(),function(data){
                                                 $("select#childemployer-village_id" ).html(data);
                                            });'
                                    ],
                                    'language' => 'en',
                                    'pluginOptions'=>['alloweClear'=>true],
