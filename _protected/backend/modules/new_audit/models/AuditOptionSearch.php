...
/**
 * AuditOptionSearch represents the model behind the search form about `backend\modules\audit\models\AuditOption`.
 */
class AuditOptionSearch extends AuditOption
{
    /**
     * @inheritdoc
     */
