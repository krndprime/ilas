 ...
 * @property IaEvalationresult[] $iaEvalationresults
...
class RdEmployer extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getIaEvalationresults()
    {
        return $this->hasMany(IaEvalationresult::className(), ['employer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(InspectionAnswer::className(), ['establishment_id' => 'id']);
    }
